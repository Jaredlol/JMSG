        ...
        SendVerificationCodeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                else
                {
                    ...
                    loadingBar.setMessage("Please wait while we confirm this number.");
     ...
     @Override
        public void onClick(View v)
        {
            ...
            else
            {
                ...
                loadingBar.setMessage("Please wait while we verify this number.");
                loadingBar.setCanceledOnTouchOutside(false);
                loadingBar.show();
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            {
                loadingBar.dismiss();
                Toast.makeText(PhoneLoginActivity.this, "Invalid Phone Number... Please re enter your phone number", Toast.LENGTH_SHORT).show();
            ...
            public void onCodeSent(String verificationId,
                ...
                loadingBar.dismiss();
                Toast.makeText(PhoneLoginActivity.this, "Code Sent. Please Verify Your Code", Toast.LENGTH_SHORT).show();
